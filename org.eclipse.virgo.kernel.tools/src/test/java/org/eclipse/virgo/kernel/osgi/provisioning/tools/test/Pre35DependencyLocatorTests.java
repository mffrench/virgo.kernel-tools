...
import org.eclipse.virgo.kernel.osgi.provisioning.tools.Pre35DependencyLocator;
...
@ConfigLocation("META-INF/pre35.test.config.properties")
public class Pre35DependencyLocatorTests {

    private final String[] searchPaths = new String[] { new File(
        "./src/test/resources/pre35-dependency-locator/manifests/{library}.libd").getAbsolutePath() };
    
    private Pre35DependencyLocator locator;
    
    @Before
    public void createDependencyLocator() throws IOException {
        this.locator = new Pre35DependencyLocator(new File("src/test/resources/pre35-dependency-locator/").getAbsolutePath(), searchPaths,
    ...
    public void importPackage() throws IOException {
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/IMPORTPACKAGE.MF")));
        Map<File, List<String>> dependencies = locator.locateDependencies(manifest);
    ...
    public void unsatisfiableImportPackage() throws IOException {        
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/UNSATISFIABLEIMPORTPACKAGE.MF")));
        try {
    ...
    public void importLibrary() throws IOException {
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/IMPORTLIBRARY.MF")));
        Map<File, List<String>> dependencies = locator.locateDependencies(manifest);
    ...
    public void importBundle() throws IOException {
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/IMPORTBUNDLE.MF")));
        Map<File, List<String>> dependencies = locator.locateDependencies(manifest);
        assertTrue(dependencies.size() + " dependencies were located.", dependencies.size() == 3);
    ...
    public void unsatisfiableImportBundle() throws IOException {        
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/UNSATISFIABLEIMPORTBUNDLE.MF")));
    ...
    public void unsatisfiableImportLibrary() throws IOException {
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/UNSATISFIABLEIMPORTLIBRARY.MF")));
        try {
            locator.locateDependencies(manifest);
            fail();
        } catch (DependencyLocationException dle) {
    ...
    public void requireBundle() throws IOException {
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/REQUIREBUNDLE.MF")));
        Map<File, List<String>> dependencies = locator.locateDependencies(manifest);
    ...
    public void unsatisfiableRequireBundle() throws IOException {
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/UNSATISFIABLEREQUIREBUNDLE.MF")));
        try {
            locator.locateDependencies(manifest);
            fail();
        } catch (DependencyLocationException dle) {
    ...
    public void testSatisfiableAndUnsatisfiable() throws IOException {
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/SATISFIABLEANDUNSATISFIABLE.MF")));
    ...
    public void testImportOfSystemPackagesWithJava6Profile() throws IOException {
        ...
        BundleManifest manifest = BundleManifestFactory.createBundleManifest(new FileReader(new File(
            "src/test/resources/pre35-dependency-locator/manifests/IMPORTSYSTEMPACKAGESJAVA6.MF")));
        Map<File, List<String>> dependencies = locator.locateDependencies(manifest);
