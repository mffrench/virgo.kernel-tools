...
public final class Pre35DependencyLocator {
     ...
     */
    public Pre35DependencyLocator(String kernelHomePath, String indexDirectoryPath, EventLogger eventLogger, BundleContext bundleContext) throws IOException {
     ...
     * @throws IOException if a problem occurs loading and parsing the configuration of the Server instance.
     */
    public Pre35DependencyLocator(String kernelHomePath, String[] additionalSearchPaths, String indexDirectoryPath, EventLogger eventLogger, BundleContext bundleContext)
        throws IOException {
        this.repository = new Pre35SystemPackageFilteringRepository(kernelHomePath, additionalSearchPaths, indexDirectoryPath,
