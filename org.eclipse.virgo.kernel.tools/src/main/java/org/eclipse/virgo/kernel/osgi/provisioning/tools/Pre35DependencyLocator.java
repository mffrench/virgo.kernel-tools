...
public final class Pre35DependencyLocator {
     ...
     */
    public Pre35DependencyLocator(String serverHomePath, String indexDirectoryPath, EventLogger eventLogger) throws IOException {
     ...
     * @throws IOException if a problem occurs loading and parsing the configuration of the Server instance.
     */
    public Pre35DependencyLocator(String serverHomePath, String[] additionalSearchPaths, String indexDirectoryPath, EventLogger eventLogger)
        throws IOException {
    	
    	this.delegate = new org.eclipse.virgo.kernel.tools.Pre35DependencyLocator(serverHomePath, additionalSearchPaths, indexDirectoryPath, eventLogger, FrameworkUtil.getBundle(getClass()).getBundleContext());
    }
